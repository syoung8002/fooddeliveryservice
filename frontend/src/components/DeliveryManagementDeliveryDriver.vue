    ...
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openUpdateLocation"
            >
                UpdateLocation
            </v-btn>
            <v-dialog v-model="updateLocationDiagram" width="500">
                <UpdateLocationCommand
                    @closeDialog="closeUpdateLocation"
...
<script>
    ...
    export default {
        name: 'DeliveryManagementDeliveryDriver',
        components:{
            Address,
        },
        props: {
